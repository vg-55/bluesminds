...
check_env "NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY" "optional"
check_env "STRIPE_WEBHOOK_SECRET" "optional"
check_env "STRIPE_PRICE_STARTER" "optional"
check_env "STRIPE_PRICE_PRO" "optional"
check_env "STRIPE_PRICE_ENTERPRISE" "optional"
