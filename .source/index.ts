...
export const meta = _runtime.meta<typeof _source.meta>([{"info":{"path":"meta.json","fullPath":"content/docs/meta.json"},"data":{"title":"Documentation","pages":["index","quickstart","authentication"]}}, {"info":{"path":"guides/meta.json","fullPath":"content/docs/guides/meta.json"},"data":{"title":"Guides","pages":["anthropic","models"]}}, {"info":{"path":"api/meta.json","fullPath":"content/docs/api/meta.json"},"data":{"title":"API Reference","pages":["chat"]}}]);